...
def setup_product():
    ...
    import collective.localrolespanel
    zcml.load_config('configure.zcml', collective.localrolespanel)
    ...
    ztc.installPackage('collective.localrolespanel')
...
setup_product()
ptc.setupPloneSite(products=['collective.localrolespanel'])
